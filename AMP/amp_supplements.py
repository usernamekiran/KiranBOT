...
skip_url_patterns = [
    ...
    for domain in [
        ...
        "bloodybloodybiblecamp.com", "nationalradiochamp.com", "supercamp.com", "miznerparkamp.com",
    ]
]
...
edit_summaries = {
    ...
    "ro": "a fost eliminată urmărirea AMP din adresele URL ([[:m:User:KiranBOT/AMP|detalii]]) ([[User talk:Usernamekiran|raportează o eroare]]) v2.2.7r",
