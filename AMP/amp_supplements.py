...
default_summary = "removed AMP tracking from URLs ([[:m:User:KiranBOT/AMP|details]]) ([[User talk:Usernamekiran|report error]]) v3.1.1-current"

edit_summaries = {
    "en": default_summary,
    "de": "Bot: AMP-Tracking aus URLs entfernt ([[:m:User:KiranBOT/AMP|details]]) ([[User talk:Usernamekiran|Fehler melden]]) v3.1.1-current",
    "es": "eliminación del seguimiento AMP en URLs ([[:m:User:KiranBOT/AMP|detalles]]) ([[User talk:Usernamekiran|reportar error]]) v3.1.1-current",
    "fr": "suppression du suivi AMP dans les URLs ([[:m:User:KiranBOT/AMP|détails]]) ([[User talk:Usernamekiran|signaler une erreur]]) v3.1.1-current",
    "it": "rimosso il tracciamento AMP dagli URL ([[:m:User:KiranBOT/AMP|dettagli]]) ([[Discussioni utente:Usernamekiran|segnala errore]]) v3.1.1-current",
    "pl": "Usunięto śledzenie AMP z adresów URL ([[:m:User:KiranBOT/AMP|szczegóły]]) ([[User talk:Usernamekiran|zgłoś błąd]]) v3.1.1-current",
    "pt": "BOT: remoção do rastreamento AMP das URLs ([[:m:User:KiranBOT/AMP|detalhes]]) ([[User talk:Usernamekiran|reportar erro]]) v3.1.1-current",
    "ab": "Ианыхуп AMP ашьҭаԥшра URL аҟынтәи ([[:m:User:KiranBOT/AMP|ахәҭаҷқәа]]) ([[User talk:Usernamekiran|aгха аҳасабырба]]). v3.1.1-current",
    "ace": "Peulacak AMP ka geubôh nibak URL ([[:m:User:KiranBOT/AMP|detil]]) ([[User talk:Usernamekiran|lapor kasalahan]]) v3.1.1-current",
    "af": "het AMP-opsporing van URL'e verwyder ([[:m:User:KiranBOT/AMP|besonderhede]]) ([[User talk:Usernamekiran|rapporteer fout]]) v3.1.1-current",
    "am": "የAMP ክትትልን ከዩአርኤሎች ተወግዷል ([[:m:User:KiranBOT/AMP|ዝርዝሮች]]) ([[User talk:Usernamekiran|ስህተት ሪፖርት አድርግ]]) v3.1.1-current",
    "ang": "afscerod AMP-tracking from URLs ([[:m:User:KiranBOT/AMP|dǣl]]) ([[User talk:Usernamekiran|forwyrd-an eor]]) v3.1.1-current",
    "ar": "إزالة تتبع AMP من عناوين URL ([[:m:User:KiranBOT/AMP|التفاصيل]]) ([[نقاش المستخدم:Usernamekiran|خطأ في الإبلاغ]]) v3.1.1-current",
    "arc": "AMP-Tracking ܡܢ URLs ܡܢܝܬ ([[:m:User:KiranBOT/AMP|ܐܢܬܐ]]) ([[User talk:Usernamekiran|ܐܙܠ ܕܠܝܠ]]) v3.1.1-current",
    "arz": "AMP-Tracking mn URLs itfrrdu ([[:m:User:KiranBOT/AMP|tafaṣṣīl]]) ([[User talk:Usernamekiran|tārīkh ϻałʿūṭ]]) v3.1.1-current",
    "as": "AMP-Tracking URLs ৰ পৰা আঁতৰোৱা হৈছে ([[:m:User:KiranBOT/AMP|বিশদ]]) ([[User talk:Usernamekiran|ভুল প'ৰিবেশ]]) v3.1.1-current",
    "ast": "Desaniciaos los parámetros de rastrexu AMP de les URL ([[:m:User:KiranBOT/AMP|detalles]]) ([[User talk:Usernamekiran|informar d'un error]]) v3.1.1-current",
    "atj": "AMP-Tracking URL hite eskeri ([[:m:User:KiranBOT/AMP|detaylar]]) ([[User talk:Usernamekiran|hata raporlama]]) v3.1.1-current",
    "av": "AMP-Tracking URL-lär hanalhiy ([[:m:User:KiranBOT/AMP|tağlar]]) ([[User talk:Usernamekiran|hataları raporlama]]) v3.1.1-current",
    "avk": "AMP-Tracking URLs dan girlemişti ([[:m:User:KiranBOT/AMP|detallar]]) ([[User talk:Usernamekiran|hatalar bildirin]]) v3.1.1-current",
    "awa": "AMP-Tracking URLs se hatawā chiṭi ([[:m:User:KiranBOT/AMP|details]]) ([[User talk:Usernamekiran|bug report]]) v3.1.1-current",
    "ay": "AMP-Tracking URLs qhanqʼa ([[:m:User:KiranBOT/AMP|detalles]]) ([[User talk:Usernamekiran|error reporte]]) v3.1.1-current",
    "az": "AMP-Tracking URL-lərdən çıxarıldı ([[:m:User:KiranBOT/AMP|detallar]]) ([[User talk:Usernamekiran|xətanı bildirmək]]) v3.1.1-current",
    "azb": "AMP-Tracking URL-lərdən qaldırıldı ([[:m:User:KiranBOT/AMP|detallar]]) ([[User talk:Usernamekiran|səhv bildirmək]]) v3.1.1-current",
    "ba": "URL-адрестарҙан AMP күҙәтеүен юйҙыҡ ([[:m:User:KiranBOT/AMP|тулыраҡ мәғлүмәт]]) ([[User talk:Usernamekiran|хата тураһында хәбәр]]) v3.1.1-current",
    "be": "выдалена адсочванне AMP з URL-адрасоў ([[:m:User:KiranBOT/AMP|падрабязнасці]]) ([[User talk:Usernamekiran|паведаміць пра памылку]]) v3.1.1-current",
    "be-tarask": "выдалена адсочванне AMP з URL-адрасоў ([[:m:User:KiranBOT/AMP|падрабязнасці]]) ([[User talk:Usernamekiran|паведаміць пра памылку]]) v3.1.1-current",
    "bg": "премахнато е AMP проследяване от URL адреси ([[:m:User:KiranBOT/AMP|подробности]]) ([[User talk:Usernamekiran|докладвай грешка]]) v3.1.1-current",
    "bn": "URL থেকে AMP ট্র্যাকিং সরানো হয়েছে ([[:m:User:KiranBOT/AMP|বিস্তারিত]]) ([[User talk:Usernamekiran|ত্রুটি রিপোর্ট করুন]]) v3.1.1-current",
    "br": "tennet eo bet an heuliañ AMP diouzh an URLoù ([[:m:User:KiranBOT/AMP|munudoù]]) ([[User talk:Usernamekiran|kemenn ur fazi]]) v3.1.1-current",
    "bs": "uklonjeno AMP praćenje iz URL-ova ([[:m:User:KiranBOT/AMP|detalji]]) ([[User talk:Usernamekiran|prijavi grešku]]) v3.1.1-current",
    "ca": "Eliminació del seguiment AMP de les URL ([[:m:User:KiranBOT/AMP|detalls]]) ([[User talk:Usernamekiran|informeu d'errors]]) v3.1.1-current",
    "ceb": "gitangtang ang pagsubay sa AMP gikan sa mga URL ([[:m:User:KiranBOT/AMP|mga detalye]]) ([[User talk:Usernamekiran|pagtaho ug sayop]]) v3.1.1-current",
    "ckb": "شوێنپێهەڵگرتنی AMP لە URLەکان لابرد ([[:m:User:KiranBOT/AMP|ووردەکاریەکان]]) ([[User talk:Usernamekiran|هەڵەیەک ڕاپۆرت بکە]]) v3.1.1-current",
    "cs": "odstraněno sledování AMP z URL adres ([[:m:User:KiranBOT/AMP|podrobnosti]]) ([[User talk:Usernamekiran|nahlásit chybu]]) v3.1.1-current",
    "cv": "URL-сенчен AMP сӑнаса тӑрассине кӑларса пӑрахнӑ ([[:m:User:KiranBOT/AMP|даннӑйсем]]) ([[User talk:Usernamekiran|йӑнӑш ҫинчен пӗлтер]]) v3.1.1-current",
    "cy": "wedi tynnu olrhain AMP o URLau ([[:m:User:KiranBOT/AMP|manylion]]) ([[User talk:Usernamekiran|adrodd am wall]]) v3.1.1-current",
    "da": "fjernede AMP-sporing fra URL'er ([[:m:User:KiranBOT/AMP|detaljer]]) ([[User talk:Usernamekiran|rapporter en fejl]]) v3.1.1-current",
    "el": "κατάργησε την παρακολούθηση AMP από τις διευθύνσεις URL ([[:m:User:KiranBOT/AMP|καθέκαστα]]) ([[User talk:Usernamekiran|αναφορά σφάλματος]]) v3.1.1-current",
    "eo": "forigis AMP-spuradon de URL-oj  ([[:m:User:KiranBOT/AMP|detaloj]]) ([[User talk:Usernamekiran|raporti eraron]]) v3.1.1-current",
    "et": "eemaldas URL-idelt AMP jälgimise  ([[:m:User:KiranBOT/AMP|detailid]]) ([[User talk:Usernamekiran|teata veast]]) v3.1.1-current",
    "eu": "AMP jarraipena URLetatik kendu da ([[:m:User:KiranBOT/AMP|xehetasunak]]) ([[User talk:Usernamekiran|errorea jakinarazi]]) v3.1.1-current",
    "fa": "حذف ردیابی AMP از URLها ([[:m:User:KiranBOT/AMP|جزئیات]]) ([[User talk:Usernamekiran|گزارش خطا]]) v3.1.1-current",
    "fi": "AMP-seuranta poistettu URL-osoitteista ([[:m:User:KiranBOT/AMP|lisätietoja]]) ([[User talk:Usernamekiran|ilmoita virheestä]]) v3.1.1-current",
    "ga": "baineadh rianú AMP de URLanna ([[:m:User:KiranBOT/AMP|sonraí]]) ([[User talk:Usernamekiran|tuairiscigh earráid]]) v3.1.1-current",
    "ha": "cire bin AMP daga URLs ([[:m:User:KiranBOT/AMP|cikakkun bayanai]]) ([[User talk:Usernamekiran|rahoton kuskure]]) v3.1.1-current",
    "he": "הסרת מעקב AMP מכתובות URL ([[:m:User:KiranBOT/AMP|פרטים]]) ([[User talk:Usernamekiran|דווח על שגיאה]]) v3.1.1-current",
    "hi": "AMP-Tracking को URLs से हटाया ([[:m:User:KiranBOT/AMP|विवरण]]) ([[User talk:Usernamekiran|त्रुटि दर्ज करें]]) v3.1.1-current",
    "hr": "uklonjeno je AMP praćenje iz URL-ova ([[:m:User:KiranBOT/AMP|detalji]]) ([[User talk:Usernamekiran|prijavi grešku]]) v3.1.1-current",
    "hu": "AMP-követés eltávolítva az URL-ekből ([[:m:User:KiranBOT/AMP|részletek]]) ([[User talk:Usernamekiran|hibabejelentés]]) v3.1.1-current",
    "hy": "հեռացվել է AMP հետևումը URL-ներից ([[:m:User:KiranBOT/AMP|մանրամասներf]]) ([[User talk:Usernamekiran|հաղորդել սխալի մասին]]) v3.1.1-current",
    "ht": "retire swivi AMP nan URL yo ([[:m:User:KiranBOT/AMP|detay]]) ([[User talk:Usernamekiran|rapòte yon erè]]) v3.1.1-current",
    "id": "Pelacakan AMP dihapus dari URL ([[:m:User:KiranBOT/AMP|rincian]]) ([[User talk:Usernamekiran|laporkan kesalahan]]) v3.1.1-current",
    "ja": "URLからアプリトラッキングを削除 ([[:m:User:KiranBOT/AMP|詳細]]) ([[User talk:Usernamekiran|エラーを報告]]) v3.1.1-current",
    "jv": "mbusak pelacakan AMP saka URL ([[:m:User:KiranBOT/AMP|rincian]]) ([[User talk:Usernamekiran|laporan kesalahan]]) v3.1.1-current",
    "ka": "URL-ებიდან AMP თვალთვალი წაიშალა ([[:m:User:KiranBOT/AMP|დეტალები]]) ([[User talk:Usernamekiran|შეცდომის შესახებ შეტყობინება]]) v3.1.1-current",
    "ko": "URL에서 AMP 추적을 제거했습니다 ([[:m:User:KiranBOT/AMP|세부]]) ([[User talk:Usernamekiran|오류 보고]]) v3.1.1-current",
    "ku": "şopandina AMP ji URLan hate rakirin ([[:m:User:KiranBOT/AMP|hûrgulî]]) ([[User talk:Usernamekiran|çewtiyek rapor bike]]) v3.1.1-current",
    "ky": "URL'дерден AMP көз салуу алынып салынды ([[:m:User:KiranBOT/AMP|майда-чүйдөсүнө чейин]]) ([[User talk:Usernamekiran|ката жөнүндө кабарлоо]]) v3.1.1-current",
    "la": "vestigationem AMP ex URL remotam ([[:m:User:KiranBOT/AMP|singularia]]) ([[User talk:Usernamekiran|errorem nuntia]]) v3.1.1-current",
    "lb": "AMP-Tracking vun URLen ewechgeholl ([[:m:User:KiranBOT/AMP|detailer]]) ([[User talk:Usernamekiran|feeler mellen]]) v3.1.1-current",
    "lmo": "eliminà el tracciament AMP di URL ([[:m:User:KiranBOT/AMP|detali]]) ([[User talk:Usernamekiran|segnalà un errur]]) v3.1.1-current",
    "lt": "pašalintas AMP stebėjimas iš URL ([[:m:User:KiranBOT/AMP|detalės]]) ([[User talk:Usernamekiran|pranešti apie klaidą]]) v3.1.1-current",
    "lv": "noņemta AMP izsekošana no URL ([[:m:User:KiranBOT/AMP|sīkāka informācija]]) ([[User talk:Usernamekiran|ziņot par kļūdu]]) v3.1.1-current",
    "mg": "nesorina ny fanaraha-maso AMP tamin'ny URL ([[:m:User:KiranBOT/AMP|tsipiriany]]) ([[User talk:Usernamekiran|mitatitra lesoka]]) v3.1.1-current",
    "min": "dihapuih palacakan AMP dari URL ([[:m:User:KiranBOT/AMP|detail]]) ([[User talk:Usernamekiran|malaporkan kasalahan]]) v3.1.1-current",
    "ml": "URL-കളിൽ നിന്ന് AMP ട്രാക്കിംഗ് നീക്കം ചെയ്തു  ([[:m:User:KiranBOT/AMP|വിശദാംശങ്ങൾ]]) ([[User talk:Usernamekiran|പിശക് റിപ്പോർട്ട് ചെയ്യുക]]) v3.1.1-current",
    "mr": "दुव्यांमधील AMP ट्रॅकिंग काढले ([[:m:User:KiranBOT/AMP|माहिती]]) ([[User talk:Usernamekiran|त्रुटी नोंदवा]]) v3.1.1-current",
    "ms": "Penjejakan AMP telah dialih keluar dari URL ([[:m:User:KiranBOT/AMP|butiran]]) ([[User talk:Usernamekiran|laporkan ralat]]) v3.1.1-current",
    "my": "AMP ခြေရာခံခြင်းကို URL မှ ဖယ်ရှားခဲ့သည်။ ([[:m:User:KiranBOT/AMP|အသေးစိတ်]]) ([[User talk:Usernamekiran|အမှားအယွင်းတစ်ခုကို သတင်းပို့ပါ။]]) v3.1.1-current",
    "nds": "Bot: AMP-Tracking ut de URLs rutmaakt ([[:m:User:KiranBOT/AMP|Details]]) ([[User talk:Usernamekiran|Fehler mellen]]) v3.1.1-current",
    "new": "यूआरएलपाखें एएमपि ट्राकिङ्ग लिकयाबिल ([[:m:User:KiranBOT/AMP|विवरण]]) ([[User talk:Usernamekiran|छगू द्वंगु रिपोर्ट]]) v3.1.1-current",
    "nl": "AMP-tracking uit URL's verwijderd ([[:m:User:KiranBOT/AMP|details]]) ([[User talk:Usernamekiran|fout melden]]) v3.1.1-current",
    "nn": "fjernet AMP-sporing fra URL-er ([[:m:User:KiranBOT/AMP|detaljer]]) ([[User talk:Usernamekiran|rapporter en feil]]) v3.1.1-current",
    "no": "fjernet AMP-sporing fra URL-er ([[:m:User:KiranBOT/AMP|detaljer]]) ([[User talk:Usernamekiran|rapporter en feil]]) v3.1.1-current",
    "oc": "suprimit lo seguiment AMP de las URL ([[:m:User:KiranBOT/AMP|detalhs]]) ([[User talk:Usernamekiran|senhalar una error]]) v3.1.1-current",
    "pa": "URL ਤੋਂ AMP ਟਰੈਕਿੰਗ ਹਟਾਈ ਗਈ ([[:m:User:KiranBOT/AMP|ਵੇਰਵੇ]]) ([[User talk:Usernamekiran|ਗਲਤੀ ਦੀ ਰਿਪੋਰਟ ਕਰੋ]]) v3.1.1-current",
    "pms": "gjavât vie il monitoraç AMP dai URL ([[:m:User:KiranBOT/AMP|detais]]) ([[User talk:Usernamekiran|segnalâ un erôr]]) v3.1.1-current",
    "ro": "a fost eliminată urmărirea AMP din adresele URL ([[:m:User:KiranBOT/AMP|detalii]]) ([[User talk:Usernamekiran|raportează o eroare]]) v3.1.1-current",
    "ru": "удалено отслеживание AMP из URL-адресов ([[:m:User:KiranBOT/AMP|подробности]]) ([[User talk:Usernamekiran|сообщить об ошибке]]) v3.1.1-current",
    "si": "URL වලින් AMP ලුහුබැඳීම ඉවත් කරන ලදී ([[:m:User:KiranBOT/AMP|විස්තර]]) ([[User talk:Usernamekiran|දෝෂයක් වාර්තා කරන්න]]) v3.1.1-current",
    "simple": default_summary,
    "sk": "odstránené sledovanie AMP z URL adries ([[:m:User:KiranBOT/AMP|detaily]]) ([[User talk:Usernamekiran|nahlásiť chybu]]) v3.1.1-current",
    "sl": "odstranjeno sledenje AMP iz URL-jev ([[:m:User:KiranBOT/AMP|podrobnosti]]) ([[User talk:Usernamekiran|prijavi napako]]) v3.1.1-current",
    "sq": "gjurmimi i AMP u hoq nga URL-të ([[:m:User:KiranBOT/AMP|detajet]]) ([[User talk:Usernamekiran|raporto një gabim]]) v3.1.1-current",
    "sr": "уклоњено AMP праћење из URL-ова ([[:m:User:KiranBOT/AMP|детаљи]]) ([[User talk:Usernamekiran|пријави грешку]]) v3.1.1-current",
    "su": "dipiceun tracking AMP tina URL ([[:m:User:KiranBOT/AMP|rinci]]) ([[User talk:Usernamekiran|kasalahan laporan]]) v3.1.1-current",
    "sv": "AMP-spårning borttagen från URL:er ([[:m:User:KiranBOT/AMP|detaljer]]) ([[User talk:Usernamekiran|rapportera fel]]) v3.1.1-current",
    "sw": "iliondoa ufuatiliaji wa AMP kutoka kwa URL ([[:m:User:KiranBOT/AMP|maelezo]]) ([[User talk:Usernamekiran|ripoti hitilafu]]) v3.1.1-current",
    "szl": "usuniynto śledzynie AMP z URL-ōw ([[:m:User:KiranBOT/AMP|detale]]) ([[User talk:Usernamekiran|zgłosić błōnd]]) v3.1.1-current",
    "ta": "URL களில் இருந்து AMP கண்காணிப்பை அகற்றியது ([[:m:User:KiranBOT/AMP|விவரங்கள்]]) ([[User talk:Usernamekiran|பிழையைப் புகாரளிக்கவும்]]) v3.1.1-current",
    "te": "URL నుండి AMP ట్రాకింగ్ తీసివేయబడింది ([[:m:User:KiranBOT/AMP|వివరాలు]]) ([[User talk:Usernamekiran|లోపాన్ని నివేదించండి]]) v3.1.1-current",
    "tg": "пайгирии AMP аз URL хориҷ карда шуд ([[:m:User:KiranBOT/AMP|тафсилот]]) ([[User talk:Usernamekiran|дар бораи хато хабар диҳед]]) v3.1.1-current",
    "th": "ลบการติดตาม AMP ออกจาก URL ([[:m:User:KiranBOT/AMP|รายละเอียด]]) ([[User talk:Usernamekiran|รายงานข้อผิดพลาด]]) v3.1.1-current",
    "tl": "inalis ang pagsubaybay sa AMP sa mga URL ([[:m:User:KiranBOT/AMP|mga detalye]]) ([[User talk:Usernamekiran|mag-ulat ng error]]) v3.1.1-current",
    "tr": "URL'lerden AMP izlemesi kaldırıldı ([[:m:User:KiranBOT/AMP|detaylar]]) ([[User talk:Usernamekiran|hata bildir]]) v3.1.1-current",
    "uk": "видалено відстеження AMP з URL-адрес ([[:m:User:KiranBOT/AMP|деталі]]) ([[User talk:Usernamekiran|повідомити про помилку]]) v3.1.1-current",
